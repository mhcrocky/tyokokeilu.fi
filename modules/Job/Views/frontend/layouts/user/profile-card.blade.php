<div class="card user-profile-card">
    <div class="profile-header p-2">
        <img class="my-5 img-company-logo" @if(Auth::User()->getAvatarUrl()) src="{{ Auth::User()->getAvatarUrl() }}" @else src="/images/empty.png" @endif " alt="">
    ...
    <div class="profile-contact pb-2">
        <div>
            ...
            <span class="contact-text">{{ Auth::User()->phone }}</span>
        </div>
        <div>
