                        ...
                        <div class="panel-body">                            
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="vendor-permission-hotel" name="vendor_permission[]" value="hotel" @if($row->hasPermissionTo('job_view')) checked @endif >
