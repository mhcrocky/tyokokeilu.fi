                        ...
                        <div class="panel-body">                            
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="vendor-permission-job" name="vendor_permission[]" value="job" @if($row->hasPermissionTo('job_view')) checked @endif >
