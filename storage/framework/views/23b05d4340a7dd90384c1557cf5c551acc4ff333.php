...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            *::after {
            ...
            a.back_btn:hover{
                background-color: #f7692d;
                text-decoration: none;
                color: white;
            }
            a.back_btn:active{
                box-shadow: 1px 0px 1px 1px #FF8149;
            }
    ...
    <div class="bravo_wrap">
        ...
        <div class="md:flex min-h-screen" style="background-color: #DAF0EF; padding:20px 0px 6em;">

            <div class="w-full flex items-center justify-center">

                <div class="max-w-sm m-8">

                    <div style="background-image: url(images/404.svg); width:455px; height:515px; background-size:cover; margin-bottom:5em;">

                    </div>
                    <h1 class=" text-center" style="color: #25465C">Whoops!</h1>
                    <p class="text-grey-darker text-center font-light mb-8 leading-normal" style="padding: 30px 0px">
                    ...
                    <a class="back_btn" href="<?php echo e(app('router')->has('home') ? route('home') : url('/')); ?>">Back to Home
                    </a>
...
<?php /**PATH D:\Task\2021-05-08(Vargar@250$)\resources\views/errors/illustrated-layout.blade.php ENDPATH**/ ?>