                                ...
                                <div class="row btn_post">
                                    <div class="col-12 p-5">
                                        <div class="text-right">
                                            <a class="btn btn-action" href="<?php echo e(route('job.vendor.index')); ?>" ><?php echo e(__('Cancel')); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\jobportal.sql\modules/Job/Views/frontend/vendorJob/detail.blade.php ENDPATH**/ ?>