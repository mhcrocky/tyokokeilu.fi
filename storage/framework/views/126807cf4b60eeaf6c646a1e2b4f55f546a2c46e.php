<form action="<?php echo e(route("job.search")); ?>" class="form " method="get">
    <div class="g-field-search">
        ...
        <button class="btn btn-primary btn-search" type="submit" style="border-radius: 44px;width: 150px;top: calc(2px - 4rem);position: relative;left: calc( 100% - 13rem);height: 3.5rem;"><?php echo e(__("Search")); ?></button>
    </div>
