...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar no-border-bottom">
        <?php echo e($row->id ? __('Edit: ').$row->title : __('Add new job')); ?>

        <?php if($row->id): ?>
            <div class="title-action">
                <a class="btn btn-info" href="<?php echo e(route('job.vendor.room.index',['job_id'=>$row->id])); ?>">
                    <i class="fa fa-hand-o-right"></i> <?php echo e(__("Manage Rooms")); ?>

                </a>
                <a href="<?php echo e(route('job.vendor.room.availability.index',['job_id'=>$row->id])); ?>" class="btn btn-warning">
            ...
            <div class="form-add-service">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-tour-location">
                        <?php echo $__env->make('Job::admin.job.location',["is_smart_search"=>"1"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php if(is_default_lang()): ?>
