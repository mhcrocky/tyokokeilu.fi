<?php if($row->getBookingEnquiryType() === "enquiry"): ?>
    <div class="bravo_single_book_wrap <?php if(setting_item('job_enable_inbox')): ?> has-vendor-box <?php endif; ?>">
...
<?php endif; ?><?php /**PATH D:\Web\Laravel\VarghaJob\tyokoleilu\tyokokeilu\modules/Job/Views/frontend/layouts/details/job-form-enquiry.blade.php ENDPATH**/ ?>