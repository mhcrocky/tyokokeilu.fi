<form class="bravo-form-login mt-4" method="POST" action="<?php echo e(route('login')); ?>">
    ...
    <div class="c-grey font-medium f14 text-center">
         <?php echo e(__('Do not have an account?')); ?> <a style="color: #AF6116"; href="/register"><?php echo e(__('Sign Up')); ?></a>
    </div>
    <div class="c-grey font-medium f14 text-center">
        <a href="<?php echo e(route("password.request")); ?>"><?php echo e(__('Forgot Password?')); ?></a>
   </div>
</form>
<?php /**PATH D:\jobportal.sql\resources\views/auth/login-form.blade.php ENDPATH**/ ?>