...
<body class="user-page <?php echo e($body_class ?? ''); ?> <?php if(setting_item_with_lang('enable_rtl')): ?> is-rtl <?php endif; ?>">
    ...
    <div class="bravo_wrap">
        ...
        <?php echo $__env->make('Layout::parts.user_room_footer',['is_user_page'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <?php echo setting_item('footer_scripts'); ?>

</body>
</html>
<?php /**PATH /home/znwaqgrx/public_html/modules/Layout/user.blade.php ENDPATH**/ ?>