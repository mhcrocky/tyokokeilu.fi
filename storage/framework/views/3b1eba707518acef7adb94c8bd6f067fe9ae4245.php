                        ...
                        <div class="panel-body">                            
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="vendor-permission-hotel" name="vendor_permission[]" value="hotel" <?php if($row->hasPermissionTo('job_view')): ?> checked <?php endif; ?> >

                                    <label class="custom-control-label" for="vendor-permission-hotel">Access Job</label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Web\Laravel\VarghaJob\tyokoleilu\tyokokeilu\modules/User/Views/admin/detail.blade.php ENDPATH**/ ?>