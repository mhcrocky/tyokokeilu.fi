            ...
            <div class="form-group" >
                ...
                <div class="form-controls">
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            <?php
                            $job_search_fields = setting_item_array('job_search_fields');
                            $types = [
                            ...
                            ?>
                            <?php $__currentLoopData = $job_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item" data-number="<?php echo e($key); ?>">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <?php if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale')): ?>
                                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text" name="job_search_fields[<?php echo e($key); ?>][title<?php echo e($key_lang); ?>]" value="<?php echo e($item['title'.$key_lang] ?? ''); ?>" class="form-control">
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                                <input type="text" name="job_search_fields[<?php echo e($key); ?>][title]" value="<?php echo e($item['title']); ?>" class="form-control">
                                            <?php endif; ?>
                                            <select name="job_search_fields[<?php echo e($key); ?>][field]" class="custom-select">
                                            ...
                                            <br>
                                            <select name="job_search_fields[<?php echo e($key); ?>][size]" class="mt-2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="job_search_fields[<?php echo e($key); ?>][position]" min="0" value="<?php echo e($item['position'] ?? 0); ?>" class="form-control">
                                        </div>
                                        <div class="col-md-1">
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="text" __name__="job_search_fields[__number__][title]" class="form-control">
                                        <select __name__="job_search_fields[__number__][field]" class="custom-select">
                                            <option value=""><?php echo e(__("-- Select field type --")); ?></option>
                                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type=>$name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <br>
                                        <select __name__="job_search_fields[__number__][size]" class="mt-2 custom-select">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" __name__="job_search_fields[__number__][position]" min="0"  class="form-control">
                                    </div>
                                    <div class="col-md-1">
                                        <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                    </div>
...
<?php endif; ?><?php /**PATH /home/znwaqgrx/public_html/modules/Job/Views/admin/settings/form-search.blade.php ENDPATH**/ ?>