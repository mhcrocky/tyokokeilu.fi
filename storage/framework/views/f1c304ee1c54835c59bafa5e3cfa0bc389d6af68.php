<div class="bravo-form-search-job" style="background: #F7F4EF;padding:30px 0px">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5" style="background-image:url('<?php echo e($bg_image_url); ?>') !important;background-size:cover;height:500px"></div>
        </div>
    </div>
</div>
<style>
...
</style><?php /**PATH D:\Web\Laravel\VarghaJob\tyokoleilu\tyokokeilu\modules/Job/Views/frontend/blocks/form-search-job/index.blade.php ENDPATH**/ ?>