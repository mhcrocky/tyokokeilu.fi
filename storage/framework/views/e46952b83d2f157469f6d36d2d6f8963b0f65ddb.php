                ...
                <div class="panel border shadow">
                    ...
                    <div class="panel-body panel-index">
                        <form action="<?php echo e(route('location.admin.store',['id'=>'-1','lang'=>request()->query('lang')])); ?>" method="post">
                            ...
                            <div class="">
                                <button class="btn btn-danger" type="submit"><?php echo e(__("Add new")); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="filter-div d-flex justify-content-between ">
                    ...
                    <div class="col-left">
                        <form method="get" action="<?php echo e(url('/admin/module/location')); ?>" class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            <input type="text" name="s" value="<?php echo e(Request()->s); ?>" class="form-control" placeholder="<?php echo e(__("Search location")); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/znwaqgrx/public_html/modules/Location/Views/admin/index.blade.php ENDPATH**/ ?>