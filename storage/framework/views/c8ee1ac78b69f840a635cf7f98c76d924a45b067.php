                ...
                <div class="form-wrapper">
                    ...
                    <form action="<?php echo e(route('review.store')); ?>" class="needs-validation" novalidate method="post">
                        ...
                        <div class="row">
                            ...
                            <?php if($tour_review_stats = setting_item("job_review_stats")): ?>
                        ...
                        <div class="text-center">
                            ...
                            <input type="hidden" name="review_service_type" value="Job">
...
<?php endif; ?>
<?php /**PATH D:\Web\Laravel\VarghaJob\tyokoleilu\tyokokeilu\modules/Job/Views/frontend/layouts/details/job-review.blade.php ENDPATH**/ ?>