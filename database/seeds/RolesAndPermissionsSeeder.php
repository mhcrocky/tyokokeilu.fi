...

{
...

    {
        ...
        Permission::findOrCreate('job_update');

        Permission::findOrCreate('job_delete');

        Permission::findOrCreate('job_manage_others');
    ...
    public function initVendor(){
        ...
        // $vendor->givePermissionTo('job_update');

        // $vendor->givePermissionTo('job_delete');
