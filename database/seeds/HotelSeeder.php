...

{
...

    {
        ...
        foreach (['Havana Lobby bar','Fiesta Restaurant','Job transport services','Free luggage deposit','Laundry Services','Pets welcome' ,'Tickets'] as $term){
        ...
        foreach ($IDs as $service_id){
            ...
            \Modules\Job\Models\Job::find($service_id)->update_service_rate();
